...
func (*Image) NewBuffer(size image.Point) (screen.Buffer, error) {
	panic("unimplemented")
}

// NewTexture implements screen.Screen
func (*Image) NewTexture(size image.Point) (screen.Texture, error) {
	panic("unimplemented")
}

// NewWindow implements screen.Screen
func (*Image) NewWindow(opts *screen.NewWindowOptions) (screen.Window, error) {
	panic("unimplemented")
}
